...
public class HtmlToWikiConverter {
    ...
    public static String htmlToWiki(String htmlValue) throws Exception {
        ...
        return htmlStreamToWiki(reader);
    }
    
    public static String htmlStreamToWiki(Reader reader) throws Exception {
    ...
    public static String webPageToWiki(String path) throws Exception {
        ...
        mf.fillWithInputStream(input);
        return htmlToWiki(mf.toString());
    }
