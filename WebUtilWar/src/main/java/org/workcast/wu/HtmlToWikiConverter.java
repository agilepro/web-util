...
public class HtmlToWikiConverter {
    ...
    public List<String>  htmlStreamToWiki(Reader reader, String path) throws Exception {
        ...
        System.out.println("=========\nPARSING FILE");
        LineNumberReader countableReader = new LineNumberReader(reader);
        HTMLParser htmlParser = new HTMLParser(path, countableReader);
        
        HTMLEditorKit.Parser parser = new ParserDelegator();
        parser.parse( countableReader, htmlParser, true );
        htmlParser.pop();
        reader.close();
...
class ParseFrame {
    ...
    WikiBlock currentBlock = new WikiBlock();
...
class HTMLParser extends HTMLEditorKit.ParserCallback {
    ...
    List<ParseFrame> wikiStack = new ArrayList<>();
    ParseFrame currentFrame;
    
    public HTMLParser(String fullUrl, LineNumberReader newReader) {
        baseUrl = findContainingUrl(fullUrl);
        countableReader = newReader;
        currentFrame = new ParseFrame();
    ...
    private void copyWhileEscaping(ParseFrame dest, String input) {
    ...
    public void pop() {
        ...
        currentFrame.finish();
        for (WikiBlock block: currentFrame.blocks) {
