...
public class SimplePageBlock {
    ...
    public List<SimplePageText> textItems = new ArrayList<SimplePageText>();
    public int blockType;
    public SimplePage thePage;
    
    public SimplePageBlock(SimplePage sp, int type) {
        thePage = sp;
        blockType = type;
    }
    ...
    public void produceHtml(Writer w) throws Exception {
        for (SimplePageText sbt : textItems) {
            sbt.produceHtml(w);
        }
    }
