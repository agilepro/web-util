...
"%JAVA_HOME%/bin/javac" -classpath "%WU_CP%" -source 1.6 -target 1.6 -d %TARGET_DIR%\wu_war\WEB-INF\classes %SOURCE_DIR%\src\org\workcast\wu\*.java %SOURCE_DIR%\src\com\purplehillsbooks\ohioscan\*.java
