...
<%!
    ...
    public void outputCleanPage(WebRequest wr, Element ele, String s) throws Exception {
...
//                }
    ...
    public void dumpLink(WebRequest wr, Element ele) throws Exception  {
    ...
    public void streamNonBlock(WebRequest wr, Element ele) throws Exception {
        String tagName = ele.nodeName().toLowerCase();
        boolean ignore = true;
        if ("a".equals(tagName)) {
            streamLink(wr, ele);
    ...
    public void streamLink(WebRequest wr, Element ele) throws Exception {
        String url = "";
